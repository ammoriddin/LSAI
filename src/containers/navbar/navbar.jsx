...
export default function Navbar() {
  return (
    <nav className='w-full sticky top-0 bg-white z-[400000000000000] border-b-[1.5px]'>
        <div className='w-full max-w-[1400px] py-[10px] px-[50px] mx-[auto] flex justify-between items-center'>
